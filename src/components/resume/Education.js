    ...
    >
      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          />
          <ResumeCard
            title="FullStack JavaScripts Development Training"
            subTitle="KnowledgeHut upGrad Bootcamp (August 2022 - January 2023)"
            result="project done"
            des="The goal was to build websites and applications using React for frontend and node.js, Express.js for backend and using a database like mongodb"
          />
          <ResumeCard
            title="React"
          ...
          <ResumeCard
            ...
            subTitle="Brainnest, Bremen Germany(May 2022 - June 2022)"
            result="project done"
            des="The goal was  learn Languages like HTML,CSS and JavaScript- the core
            tools every web developer needs to know to create
            stunning cascading websites and also Engaging
            projects"
          />
          <ResumeCard
            title="JavaScripts"
